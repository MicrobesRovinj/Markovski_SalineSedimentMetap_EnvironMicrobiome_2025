...
subtitle: "**Influence of seagrass decline on the metabolic profile of sediment microbial communities**"
...
(ref:samples) Sample ID, sampling date and site, and sediment depth and layer for each protein sample with successfully obtained MS/MS spectra.
...
# Remove samples with failed MS/MS run
metadata <- metadata %>%
  filter(msms_raw != "run_failure")
